...
from .treesegmentation_dialog import TreeSegmentationDialog
import os.path
...
class TreeSegmentation:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TreeSegmentation_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TreeSegmentation', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/treesegmentation/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Run Tree Segmentation'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = TreeSegmentationDialog()
        ...
        if result:
            ...
            main("C:\\Users\\moose\\Desktop\\.school\\capstone\\Capstone-TSFAPC\\sample_data\\medium_nno.las")
