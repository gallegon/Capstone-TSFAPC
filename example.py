...
import laspy
# import numpy as np
from .treesegmentation import treeseg_lib
...
class Example:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Tree Segmentation Algorithm'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            shared_ratio_weight = float(self.dlg.shared_ratio.text())
            top_distance_weight = float(self.dlg.top_distance.text())
